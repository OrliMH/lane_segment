...
def encode_labels(color_mask):
    ...
    id_train = {0:[0, 249, 255], 
            1:[200, 204, 213, 209, 206, 207],
            2:[201, 203, 211, 208],
            3:[216, 217, 215],
            4:[218, 219],
            5:[210, 232],
            6:[214],
            7:[202, 220, 221, 222, 231, 224, 225, 226, 230, 228, 229, 233],
            8:[205, 212, 227, 223, 250]
            }
    for i in range(9):
...
def decode_color_labels(labels):
    ...
    # 4
    decode_mask[0][labels == 4] = 102
    decode_mask[1][labels == 4] = 102
    decode_mask[2][labels == 4] = 156
    # 5
    decode_mask[0][labels == 5] = 128
    decode_mask[1][labels == 5] = 64
    decode_mask[2][labels == 5] = 128
    # 6
    decode_mask[0][labels == 6] = 190
    decode_mask[1][labels == 6] = 153
    decode_mask[2][labels == 6] = 153
    # 7
    decode_mask[0][labels == 7] = 0
    decode_mask[1][labels == 7] = 0
    decode_mask[2][labels == 7] = 230

    # 8
    decode_mask[0][labels == 8] = 255
    decode_mask[1][labels == 8] = 128
    decode_mask[2][labels == 8] = 0
